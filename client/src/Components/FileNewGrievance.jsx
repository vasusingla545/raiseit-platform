      ...
      axios
        ...
        .catch((error) => {
          ...
          if (error.response && error.response.data) {
            // Try to show a specific message if available
            alert("Error Occurred: " + (error.response.data.msg || error.response.data.message || JSON.stringify(error.response.data)));
